...
jQuery( document ).ready(
	function ($) {
		...
		$( '.menu-item-has-children' ).click(
			function () {
				var subMenu = $( this ).find( '.anony-sub-menu' );
				if ( ! subMenu.hasClass('anony-opened') ) {
					subMenu.addClass('anony-opened')
				} else {
					subMenu.removeClass('anony-opened')
				}
			}
		);
		$( '#anony-menu-toggle' ).click(
			function () {
