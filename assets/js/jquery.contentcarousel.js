...
(function ($) {
	var	aux = {
		...
		navigate	: function ( dir, $el, $wrapper, opts, cache ) {
			...
			if ( dir === 1 ) {
				$wrapper.find( 'div.anony-ca-item:lt(' + scroll + ')' ).each(
					function (i) {
				...
				$wrapper.find( 'div.anony-ca-item:gt(' + ( cache.totalItems - 1 - scroll ) + ')' ).each(
					function (i) {
			...
			$wrapper.find( 'div.anony-ca-item' ).each(
				function (i) {
					var $item = $( this );
					$item.stop().animate(
						{
