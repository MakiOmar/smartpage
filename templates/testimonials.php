...
<div class="<?php echo esc_html( $slider_class ); ?>anony-testimonial-item anony-grid-col anony-grid-col-sm-3 anony-inline-flex anony-flex-column">
	<div class="anony-grid-row anony-flex-grow-initial">
		<div class="anony-grid-col anony-grid-col-2 anony-inline-flex flex-h-center">
			<?php
		...
		<div class="anony-grid-col anony-grid-col-10 anony-inline-flex anony-flex-column">
			<p style="line-height:initial;padding-top:12px"><strong><?php the_title(); ?></strong></p>
			<span>
				<?php
				for ( $r = 1; $r <= 5; $r++ ) {
