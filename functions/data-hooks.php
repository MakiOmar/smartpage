...
add_action( 'anony_before_inculde_single', function($data, $post_type){
	switch ($post_type) {
		case 'anony_download':
...
add_filter( 'anony_download_loop_data',function( $temp, $ID){
	
	$temp['thumb_img'] = get_the_post_thumbnail($ID, [160, 180]);
