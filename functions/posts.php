 ...
 */
add_filter(
    'anony_post_types', function ($custom_post_types) {
        $custom_posts = [
                    'anony_download'=>
                        [
 ...
 */
add_filter(
    'anony_taxonomies', function ($anony_custom_taxs) {
 ...
 */
add_filter(
    'anony_post_taxonomies', function ($anony_post_taxonomies) {
 ...
 */
add_filter(
    'anony_taxonomy_posts', function ($anony_tax_posts) {
 ...
 */
add_filter(
    'anony_anony_news_supports', function ($support) {
        return ['editor'];
    }
);
...
//Filter reply link
add_filter(
    'comment_reply_link', function ($link, $args, $comment, $post) {
        if(wp_doing_ajax()) {
...
add_filter(
    'comment_form_defaults', function ( $args ) {
...
add_filter(
    'post_thumbnail_html', function ( $html) {
