...
function anony_theme_skin(){
	...
	<style type="text/css">
		.anony-skew-bg::after, .page-numbers li, .active, .button, .anony-active-tab,
...
.anony-post-image-wrapper h4, .f-post-title, .reply, .dun_text:after {
		...
		.single-download, .anony-toggle-sidebar, #anony-main_nav_con, .anony-popular-tabs span:not(.anony-active-tab):nth-child(2) {
		  background-color: <?php echo esc_html( $primary_color ) ;?>;
		}
		.fa-calendar, .fa-comments-o, .fa-folder-open, .fa-eye, .fa-download, a, h1, h2, h3, h4, h5, h6, .anony-breadcrumbs li, .anony-breadcrumbs a {
