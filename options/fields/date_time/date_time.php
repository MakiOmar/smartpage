...
class ANONY_optf__Date_Time extends ANONY__Theme_Settings{	
    ...
    function enqueue() {
		...
		wp_enqueue_script('jquery-ui-timepicker-addon',Theme_Settings_URI.'/fields/date_time/jquery-ui-timepicker-addon.js',array('jquery', 'jquery-ui-datepicker', 'jquery-ui-core'));
